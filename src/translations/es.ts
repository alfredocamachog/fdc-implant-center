  ...
  cases: {
    ...
    cards: [
      ...
      },
      {
        ...
        modal: {
          overview: {
            title: 'Una sonrisa reconstruida desde un desgaste dental severo',
            paragraphs: [
              'Miguel llegó a nuestra clínica con desgaste dental avanzado causado por años de bruxismo y colapso de mordida. Sus dientes estaban tan desgastados que sentía que ya masticaba directamente sobre sus encías.',
              'Más allá de los problemas funcionales, la pérdida severa de estructura dental también había cambiado su apariencia facial, dándole un aspecto cansado y envejecido y reduciendo el soporte general del rostro.',
              'Él quería más que dientes más fuertes. Quería volver a sentirse cómodo al sonreír, comer y hablar.',
            ],
            upperTitle: 'El problema: desgaste severo y colapso de mordida',
            upperDescription: 'El desgaste dental excesivo puede afectar de forma drástica tanto la función oral como la estética facial.',
            upperPoints: [
              'Dientes extremadamente desgastados y acortados',
              'Pérdida de altura de mordida y eficiencia al masticar',
              'Sensación de "morder sobre las encías"',
              'Colapso facial y apariencia envejecida',
              'Fatiga muscular y molestia mandibular',
              'Menor confianza al sonreír',
            ],
            lowerTitle: 'Enfoque del tratamiento',
            lowerDescription: 'Restaurar función, estética y soporte facial mediante una rehabilitación totalmente personalizada.',
            lowerPoints: [
              'Reconstruir la posición correcta de mordida y la anatomía dental',
              'Recuperar comodidad al masticar y hablar',
              'Entregar un resultado natural, duradero y funcional a largo plazo',
            ],
          },
          results: {
            title: 'Resultados',
            intro: 'Usando planeación digital avanzada y un enfoque totalmente personalizado, reconstruimos la mordida, la sonrisa y el soporte facial de Miguel.',
            points: [
              'Restauración de la dimensión vertical (elevación de mordida)',
              'Rehabilitación funcional planificada digitalmente',
              'Mejoría en comodidad y estabilidad al masticar',
              'Mejor soporte facial para una apariencia más juvenil',
              'Reconstrucción estética de apariencia natural',
              'Balance funcional y durabilidad a largo plazo',
            ],
            whyTitle: 'Impacto más allá de la sonrisa',
            whyPoints: [
              'Al restaurar la posición correcta de la mordida y la anatomía dental, logramos mejorar de forma drástica no solo su sonrisa, sino también su apariencia facial general, su comodidad y su confianza.',
            ],
          },
        },
      },
      {
        ...
        modal: {
          overview: {
            title: 'Restaurar función, estabilidad y confianza',
            paragraphs: [
              'Esta paciente llegó con coronas en mal estado, prótesis desgastadas y una pérdida importante de función dental que había afectado progresivamente tanto la estética como su calidad de vida.',
              'Con el tiempo, el deterioro del trabajo dental existente generó inestabilidad en la mordida, dificultad para masticar y pérdida de soporte facial adecuado. El estado de las restauraciones ya no ofrecía la función, comodidad ni apariencia que la paciente buscaba.',
              'Más allá de las complicaciones dentales, el colapso del soporte y el desgaste de las restauraciones contribuyeron a una apariencia facial más envejecida y menor confianza al sonreír.',
            ],
            upperTitle: 'El reto: restaurar más que solo dientes',
            upperDescription: '',
            upperPoints: [
              'Coronas en mal estado y trabajo protésico comprometido',
              'Pérdida de estabilidad y oclusión adecuada',
              'Dificultad para masticar y hablar con comodidad',
              'Pérdida de soporte facial y dimensión vertical',
              'Apariencia de sonrisa envejecida y disminución de la confianza',
            ],
            lowerTitle: 'Plan de tratamiento',
            lowerDescription:
              'Se diseñó cuidadosamente una rehabilitación oral integral para recuperar tanto la función como la estética. El tratamiento combinó prótesis totales, nuevas coronas y una rehabilitación removible inferior para restablecer una sonrisa estable, funcional y de apariencia natural.',
            lowerPoints: [
              'Cada aspecto del caso se planificó de forma digital y clínica para asegurar armonía entre función, comodidad, balance facial y estabilidad a largo plazo.',
            ],
          },
          results: {
            title: 'Una sonrisa nueva, funcional y con confianza',
            intro: '',
            points: [
              'Mejor eficiencia y comodidad al masticar',
              'Recuperación del soporte facial y armonía de la sonrisa',
              'Apariencia más juvenil y equilibrada',
              'Mayor estabilidad al hablar y al comer',
              'Estética natural adaptada a los rasgos faciales de la paciente',
              'Confianza renovada y mejor calidad de vida',
            ],
            whyTitle: 'Más allá del reemplazo dental',
            whyPoints: [
              'Esta transformación no se trató solo de reemplazar trabajo dental, sino de restaurar comodidad, confianza y función oral general mediante un enfoque de rehabilitación personalizado e integral.',
            ],
          },
        },
      },
