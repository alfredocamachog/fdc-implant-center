...
export const esTranslations = {
  ...
  cases: {
    ...
    cards: [
      ...
      {
        id: 'demo-02',
        name: 'Paciente: Caso Demo 2',
        treatment: 'Tratamiento: Rehabilitación implantosoportada parcial',
        location: 'Ubicación: Nogales, México',
        images: [
          { src: 'https://picsum.photos/seed/fdc-demo2-01/900/620', sensitive: false },
          { src: 'https://picsum.photos/seed/fdc-demo2-02/900/620', sensitive: false },
          { src: 'https://picsum.photos/seed/fdc-demo2-03/900/620', sensitive: false },
          { src: 'https://picsum.photos/seed/fdc-demo2-04/900/620', sensitive: false },
        ],
        modal: {
          overview: {
            title: 'Restauración funcional con enfoque estético',
            paragraphs: [
              'Este segundo caso demo muestra la misma experiencia visual con carrusel, control sensible y modal en pestañas.',
              'La estructura queda lista para cargar historia clínica real, protocolo y seguimiento con el mismo formato.',
            ],
            upperTitle: 'Fase protésica superior',
            upperDescription: 'Se realizó planificación digital para optimizar ajuste, estética y estabilidad en la restauración final.',
            upperPoints: [
              '✔️ Planeación digital individualizada',
              '✔️ Ajuste oclusal guiado',
              '✔️ Materiales de alta resistencia',
              '✔️ Diseño natural de sonrisa',
            ],
            lowerTitle: 'Fase funcional complementaria',
            lowerDescription: 'Se reforzó función masticatoria y confort diario con controles progresivos y ajustes de mantenimiento.',
            lowerPoints: [
              '✔️ Mejor función al masticar',
              '✔️ Confort en uso diario',
              '✔️ Seguimiento por etapas',
              '✔️ Mantenimiento sencillo',
            ],
          },
          results: {
            title: 'Resultados:',
            intro: 'Con este enfoque, el paciente obtiene:',
            points: [
              '✔️ Mayor seguridad al sonreír',
              '✔️ Mejor rendimiento masticatorio',
              '✔️ Apariencia más natural',
              '✔️ Mejor calidad de vida',
            ],
            whyTitle: 'Ventajas del protocolo en nuestra clínica',
            whyPoints: [
              '✔️ Diagnóstico digital completo',
              '✔️ Tratamiento personalizado',
              '✔️ Materiales premium',
              '✔️ Acompañamiento clínico continuo',
              '✔️ Ubicación fronteriza estratégica',
            ],
          },
        },
      },
