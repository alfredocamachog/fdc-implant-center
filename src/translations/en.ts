  ...
  cases: {
    ...
    cards: [
      ...
      },
      {
        ...
        modal: {
          overview: {
            title: 'Restoring Function, Stability, and Confidence',
            paragraphs: [
              'This patient came to us with failing crowns, worn prostheses, and significant loss of dental function that had progressively affected both aesthetics and quality of life.',
              'Over time, the deterioration of the existing dental work created instability in her bite, difficulty chewing, and loss of proper facial support. The condition of the restorations no longer provided the function, comfort, or appearance the patient desired.',
              'Beyond the dental complications, the collapse in support and worn restorations contributed to a more aged facial appearance and reduced confidence when smiling.',
            ],
            upperTitle: 'The Challenge: Restoring More Than Just Teeth',
            upperDescription: '',
            upperPoints: [
              'Failing crowns and compromised prosthetic work',
              'Loss of stability and proper occlusion',
              'Difficulty chewing and speaking comfortably',
              'Loss of facial support and vertical dimension',
              'Aged smile appearance and decreased confidence',
            ],
            lowerTitle: 'The Treatment Plan',
            lowerDescription:
              'A comprehensive full mouth rehabilitation was carefully designed to restore both function and aesthetics. The treatment combined complete dentures, new crowns, and a removable lower rehabilitation to reestablish a stable, functional, and natural-looking smile.',
            lowerPoints: [
              'Every aspect of the case was digitally and clinically planned to ensure harmony between function, comfort, facial balance, and long-term stability.',
            ],
          },
          results: {
            title: 'A Functional and Confident New Smile',
            intro: '',
            points: [
              'Improved chewing efficiency and comfort',
              'Restored facial support and smile harmony',
              'More youthful and balanced appearance',
              'Enhanced stability during speaking and eating',
              'Natural aesthetics tailored to the patient’s facial features',
              'Renewed confidence and quality of life',
            ],
            whyTitle: 'Beyond Dental Replacement',
            whyPoints: [
              'This transformation was not only about replacing dental work - it was about restoring comfort, confidence, and overall oral function through a personalized and comprehensive rehabilitation approach.',
            ],
          },
        },
      },
