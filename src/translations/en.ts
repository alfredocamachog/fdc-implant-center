...
export const enTranslations = {
  ...
  cases: {
    ...
    cards: [
      ...
      {
        id: 'demo-02',
        name: 'Patient: Demo Case 2',
        treatment: 'Treatment: Partial implant-supported rehabilitation',
        location: 'Location: Nogales, Mexico',
        images: [
        ...
        modal: {
          overview: {
            title: 'Functional restoration with an aesthetic approach',
            paragraphs: [
              'This second demo case showcases the same visual experience with carousel, sensitive-control, and tabbed modal.',
              'The structure is ready to load real clinical history, protocol details, and follow-up using the same format.',
            ],
            upperTitle: 'Upper prosthetic phase',
            upperDescription: 'Digital planning was used to optimize fit, esthetics, and long-term stability in the final restoration.',
            upperPoints: [
              '✔️ Individualized digital planning',
              '✔️ Guided occlusal adjustment',
              '✔️ High-strength materials',
              '✔️ Natural smile design',
            ],
            lowerTitle: 'Complementary functional phase',
            lowerDescription: 'Masticatory function and day-to-day comfort were reinforced with staged controls and maintenance adjustments.',
            lowerPoints: [
              '✔️ Better chewing performance',
              '✔️ Daily comfort',
              '✔️ Staged follow-up',
              '✔️ Easy maintenance',
            ],
          ...
          results: {
            title: 'Results:',
            intro: 'With this approach, the patient gains:',
            points: [
              '✔️ Greater confidence when smiling',
              '✔️ Improved chewing function',
              '✔️ A more natural appearance',
              '✔️ Better quality of life',
            ],
            whyTitle: 'Advantages of our clinical protocol',
            whyPoints: [
              '✔️ Comprehensive digital diagnostics',
              '✔️ Personalized treatment',
              '✔️ Premium materials',
              '✔️ Continuous clinical follow-up',
              '✔️ Strategic border location',
            ],
          },
        },
      },
